...
class TejidosBlandosManejoAmbulatorio extends StatefulWidget {
  const TejidosBlandosManejoAmbulatorio({Key key}) : super(key: key);

  @override
  _TejidosBlandosManejoAmbulatorioState createState() => _TejidosBlandosManejoAmbulatorioState();
}

class _TejidosBlandosManejoAmbulatorioState extends State<TejidosBlandosManejoAmbulatorio> {
  @override
