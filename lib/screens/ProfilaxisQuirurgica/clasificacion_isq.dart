                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          rombo(context),
                          TextSpan(
                            text: "Según los tejidos comprometidos la ISQ se puede clasificar como:\n\n",
                          ...
                          TextSpan(
                            text: "Infección que involucra solo\n    la piel o el tejido subcutáneo de la\n    incisión.\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "•  ",
                          ...
                          TextSpan(
                            text: "Infección que involucra\n    tejidos blandos profundos de la incisión\n    (Ejem: capas de fascia y músculo)\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "•  ",
                          ...
                          TextSpan(
                            text: "Infección que\n    involucra cualquier parte de la anatomía\n    (por ejemplo, órganos o espacios), que\n    no sea la incisión, abierta o manipulada\n    durante el procedimiento quirúrgico.\n",
                            style: _estiloLetra1(context),
                          ),
                        ]
                    ),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: "Infección que se identifica en la\n    incisión primaria en un paciente que ha\n    tenido un procedimiento quirúrgico con\n    una o más incisiones (por ejemplo,\n    incisión de cesárea o incisión en el\n    pecho para bypass de arteria coronaria).\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "•  ",
                          ...
                          TextSpan(
                            text: "Infección que se identifica\n    en la incisión secundaria en un paciente\n    que ha tenido una operación con más de\n    una incisión (por ejemplo, incisión en el\n    sitio donante para bypass de arteria\n    coronaria).\n",
                            style: _estiloLetra1(context),
                          ),
                        ]
                    ),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          rombo(context),
                          TextSpan(
                            text: "Algunos sitios específicos de ISQ órgano/espacio son:\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "•  ",
                          ...
                          TextSpan(
                            text: "Infección de la articulación periprotésica\n",
                            style: _estiloLetra1(context),
                          ),
