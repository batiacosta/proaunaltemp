...
class PosoperatoriaProfilaxisQuirurgica extends StatefulWidget {
  const PosoperatoriaProfilaxisQuirurgica({Key key}) : super(key: key);

  @override
  _PosoperatoriaProfilaxisQuirurgicaState createState() => _PosoperatoriaProfilaxisQuirurgicaState();
}

class _PosoperatoriaProfilaxisQuirurgicaState extends State<PosoperatoriaProfilaxisQuirurgica> {
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                divisorTitulado(context, "POSOPERATORIA"),
                ...
                Container(
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          TextSpan(
                            text: "Importante: A continuación se hace mención a la profilaxis posoperatoria, no a los escenarios de tratamiento, ",
                            style: _estiloLetraColorMedio(context),
                          ),

                          TextSpan(
                            text: "ya sea empírico o dirigido o de infección posquirúrgica, como son los casos de: absceso, empiema, urgencia urológica con bacteriuria, fractura abierta o abdomen abierto posquirúrgico por infección intraabdominal, entre otros casos, en los cuales el paciente debe recibir manejo antimicrobiano en el escenario de tratamiento según las recomendaciones particulares.\n\n",
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          triangulito(context),
                          TextSpan(
                            text: "No prolongar la administración de la profilaxis quirúrgica antimicrobiana después de cerrar la incisión quirúrgica.\n\n",
                            style: _estiloLetra1(context),
                          ),
                          triangulito(context),
                          TextSpan(
                            text: "No prolongar la administración de la profilaxis quirúrgica antimicrobiana incluso en presencia de dispositivos de drenaje posoperatorio o sondas uretrales.\n\n",
                            style: _estiloLetra1(context),
                          ),
                        ]
                    ),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: "No prolongar la administración de la\n    profilaxis quirúrgica antimicrobiana por\n    más de 24 horas después de finalizar el\n    procedimiento aún en escenarios\n    seleccionados.\n",
                            style: _estiloLetra1(context),
                          ),
                        ]
                    ),
