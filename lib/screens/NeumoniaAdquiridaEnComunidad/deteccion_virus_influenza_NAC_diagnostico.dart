...
class DeteccionVirusInfluenzaNACDiagnostico extends StatefulWidget {
  const DeteccionVirusInfluenzaNACDiagnostico({Key key}) : super(key: key);

  @override
  _DeteccionVirusInfluenzaNACDiagnosticoState createState() => _DeteccionVirusInfluenzaNACDiagnosticoState();
}

class _DeteccionVirusInfluenzaNACDiagnosticoState extends State<DeteccionVirusInfluenzaNACDiagnostico> {
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                menuDiagnostico(context, "Detección del virus de la influenza"),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          chulo(context),
                          TextSpan(
                            text: "Realizar pruebas para detección del virus de la influenza con prueba de amplificación de ácido nucleíco de influenza (que se prefiere a una prueba rápida de antígeno de influenza) en pacientes que:\n\n",
                          ...
                          TextSpan(
                            text: "Tienen comorbilidad (respiratoria,\n    cardiovascular o inmunosupresión).\n",
                            style: _estiloLetra1(context),
                          ),
                        ]
                    ),
