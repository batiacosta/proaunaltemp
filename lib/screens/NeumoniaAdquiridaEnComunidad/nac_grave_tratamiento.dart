...
class NACGraveTratamiento extends StatefulWidget {
  const NACGraveTratamiento({Key key}) : super(key: key);

  @override
  _NACGraveTratamientoState createState() => _NACGraveTratamientoState();
}

class _NACGraveTratamientoState extends State<NACGraveTratamiento> {
  @override
                ...
                SizedBox(
                  ...
                  child: TextButton(
                    ...
                    onPressed: (){
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => NACGraveSinFactoresRiesgo()),
                      );
                    },
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: TextButton(
                    ...
                    onPressed: (){
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => NACGraveConFactoresRiesgo()),
                      );
                    },
                  ),
                ),
