...
class CURB65 extends StatefulWidget {
  const CURB65({Key key}) : super(key: key);

  @override
  _CURB65State createState() => _CURB65State();
}

class _CURB65State extends State<CURB65> {
  ...
  List<int> valorGuardad = [ 0, 0, 0, 0, 0];
  int edadNumber = 0;
  String resultado = "";
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                filas(context, 1, 1, 'Nitrógeno ureico ≥ 19 mg/dL (7 mmol/L)', 1),
                filas(context, 0, 2, 'Frecuencia respiratoria ≥ 30/m', 1),
                filas(context, 1, 3, 'Presión arterial sistólica < 90 mm Hg o Presión arterial diastólica ≤ 60 mm Hg', 1),
                filas(context, 0, 4, 'Edad ≥ 65 años', 1),
                ...
                Container(
                  ...
                  child: TextButton(
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all<Color>(Color(0xff51A8B1),),
                    ),
                    child:RichText(
                      textAlign: TextAlign.center,
                      text: TextSpan(
                ...
                Container(height: MediaQuery.of(context).size.height*0.015,),
                Image(image: AssetImage("assets/NeumoniaAdquiridaEnComunidad/CURB65BTablaNACTratamiento.png")),
