...
class ProcalcitoninaNACTratamiento extends StatefulWidget {
  const ProcalcitoninaNACTratamiento({Key key}) : super(key: key);

  @override
  _ProcalcitoninaNACTratamientoState createState() => _ProcalcitoninaNACTratamientoState();
}

class _ProcalcitoninaNACTratamientoState extends State<ProcalcitoninaNACTratamiento> {
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                menuDiagnostico(context, "Procalcitonina"),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          rombo(context),
                          TextSpan(
                            text: "No solicitar procalcitonina sérica (PCT) en adultos con NAC clínicamente sospechada y confirmada por imagen, para decidir el inicio de la terapia antimicrobiana.\n\n",
