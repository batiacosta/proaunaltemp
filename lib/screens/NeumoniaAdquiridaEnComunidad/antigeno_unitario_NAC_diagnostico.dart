...
class AntigenoUnitarioNACDiagnostico extends StatefulWidget {
  const AntigenoUnitarioNACDiagnostico({Key key}) : super(key: key);

  @override
  _AntigenoUnitarioNACDiagnosticoState createState() => _AntigenoUnitarioNACDiagnosticoState();
}

class _AntigenoUnitarioNACDiagnosticoState extends State<AntigenoUnitarioNACDiagnostico> {
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                menuDiagnostico(context, "Antígeno urinario"),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          chulo(context),
                          TextSpan(
                            text: "Realizar el análisis de antígeno urinario neumocócico en adultos con NAC grave .\n\n",
