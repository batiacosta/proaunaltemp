...
class NACModeradaConFactoresRiesgo extends StatefulWidget {
  const NACModeradaConFactoresRiesgo({Key key}) : super(key: key);

  @override
  _NACModeradaConFactoresRiesgoState createState() => _NACModeradaConFactoresRiesgoState();
}

class _NACModeradaConFactoresRiesgoState extends State<NACModeradaConFactoresRiesgo> {
  @override
    ...
    if(conRiesgo==true){
      return new Column(
        children: [
          ...
          VerImagen("assets/NeumoniaAdquiridaEnComunidad/tablaNACModeradoConRiesgo.png", 1, "t"),
        ],
      );
