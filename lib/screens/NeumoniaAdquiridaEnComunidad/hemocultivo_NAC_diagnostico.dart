...
class HemocultivoNACDiagnostico extends StatefulWidget {
  const HemocultivoNACDiagnostico({Key key}) : super(key: key);

  @override
  _HemocultivoNACDiagnosticoState createState() => _HemocultivoNACDiagnosticoState();
}

class _HemocultivoNACDiagnosticoState extends State<HemocultivoNACDiagnostico> {
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                menuDiagnostico(context, "Hemocultivos"),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          chulo(context),
                          TextSpan(
                            text: "Tomar hemocultivos previo al inicio de tratamiento antimicrobiano en adultos con NAC de manejo intrahospitalario que:\n",
                            style: _estiloLetra1(context),
                          ),
                        ]
                    ),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: "Realizar la toma del conjunto de hemocultivos acorde a los parámetros definidos en el manual de toma de muestras del Instituto Nacional de Salud. \n\n",
                            style: _estiloLetra1(context),
                          ),
                        ]
                    ),
