...
class ETVascularPeriferico extends StatefulWidget {
  ETVascularPeriferico({Key key}) : super(key: key);

  @override
  State<ETVascularPeriferico> createState() => _ETVascularPerifericoState();
}

class _ETVascularPerifericoState extends State<ETVascularPeriferico> {
      ...
      child: ListView(
        children: [
          ...
          Container(
            width: double.infinity,
            margin: s.margenNormal(context),
            child: Caprini(atrasRoute: '/ETVascularPeriferico'),
          ),
          s.espacio(),
          Container(
            width: double.infinity,
                ...
                InkWell(
                  ...
                  onTap: ()=> Navigator.push(
                      ...
                      new MaterialPageRoute(
                          ...
                          new ManipularImagenCaprini('assets/EnfermedadTromboembolicaVenosa/VascularPerifericoTabla1.png'))),
                ),
                DividerGeneral(color: c.enfermedadTromboembolicaVenosaRojo,),
                InkWell(
                  child: Container(
                    margin: s.margenDelgado(context),
                    child: Text(
                      'Abierto de Aorta Abdominal ; o IMC ≥30 kg/m2, Disnea en preoperatorio, Uso crónico de esteroides, Aneurisma roto.\nDuración operatoria  ≥5 h, Trasfusión ≥5 U, \nVentilación mecánica postoperatoria  ≥48 h.\nComplicación postoperatoria (Lesión renal aguda, infección/sepsis), Reintervención.',
                      style: s.regular(context, c.tromboprofilaxisGris),
                      textAlign: TextAlign.left,
                    ),
                  ),
                  onTap: ()=> Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (BuildContext context) =>
                          new ManipularImagenCaprini('assets/EnfermedadTromboembolicaVenosa/VascularPerifericoTabla2.png'))),
                ),
                DividerGeneral(color: c.enfermedadTromboembolicaVenosaRojo,),
                s.espacio(),
              ],
              ...
              children: [
                ...
                InkWell(
                  ...
                  onTap: ()=> Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (BuildContext context) =>
                          new FactoresRiesgoSangrado(atrasRoute: '/ETVascularPeriferico'))),
                ),
                s.espacio(),
                InkWell(
                  child: RoundedContainerRegularBold(
                  ...
                  onTap: ()=> Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (BuildContext context) =>
                          new ContraindicacionesMecanica(atrasRoute: '/ETVascularPeriferico'))),
                ),
