...
class ETOtorrinolaringologia extends StatefulWidget {
  ETOtorrinolaringologia({Key key}) : super(key: key);

  @override
  State<ETOtorrinolaringologia> createState() => _ETOtorrinolaringologiaState();
}

class _ETOtorrinolaringologiaState extends State<ETOtorrinolaringologia> {
              ...
              children: [
                ...
                InkWell(
                  child: Container(
                    ...
                    child: Text(
                      'Escisión cavidad oral u Oro faringe, Disección Cuello, Tosilectomia, Tiroides o Paratiroides, Glándula salivares procedimientos Otológicos',
                  ...
                  onTap: ()=> Navigator.push(
                      ...
                      new MaterialPageRoute(
                          ...
                          new ManipularImagenCaprini('assets/EnfermedadTromboembolicaVenosa/OtorrinolaringologiaTabla1.png'))),
                ),
                DividerGeneral(color: c.enfermedadTromboembolicaVenosaRojo,),
                InkWell(
                  child: Container(
                  ...
                  onTap: ()=> Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (BuildContext context) =>
                          new ManipularImagenCaprini('assets/EnfermedadTromboembolicaVenosa/OtorrinolaringologiaTabla2.png'))),
                ),
                DividerGeneral(color: c.enfermedadTromboembolicaVenosaRojo,),
                s.espacio(),
              ],
              ...
              children: [
                ...
                InkWell(
                  ...
                  onTap: ()=> Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (BuildContext context) =>
                          new FactoresRiesgoSangrado(atrasRoute: '/ETOtorrinolaringologia'))),
                ),
                s.espacio(),
                InkWell(
                  child: RoundedContainerRegularBold(
                  ...
                  onTap: ()=> Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (BuildContext context) =>
                          new ContraindicacionesMecanica(atrasRoute: '/ETOtorrinolaringologia'))),
                ),
