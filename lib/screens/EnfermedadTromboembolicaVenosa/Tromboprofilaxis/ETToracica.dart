...
class ETToracica extends StatefulWidget {
  ETToracica({Key key}) : super(key: key);

  @override
  State<ETToracica> createState() => _ETToracicaState();
}

class _ETToracicaState extends State<ETToracica> {
              ...
              children: [
                ...
                InkWell(
                  child: Container(
                    ...
                    child: Text(
                      'Ausencia de malignidad o Toracoscopia Diagnóstica',
                  ...
                  onTap: ()=> Navigator.push(
                      ...
                      new MaterialPageRoute(
                          ...
                          new ManipularImagenCaprini('assets/EnfermedadTromboembolicaVenosa/ToracicaTabla1.png'))),
                ),
                DividerGeneral(color: c.enfermedadTromboembolicaVenosaRojo,),
                InkWell(
                  child: Container(
                  ...
                  onTap: ()=> Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (BuildContext context) =>
                          new ManipularImagenCaprini('assets/EnfermedadTromboembolicaVenosa/ToracicaTabla2.png'))),
                ),
                DividerGeneral(color: c.enfermedadTromboembolicaVenosaRojo,),
                InkWell(
                  child: Container(
                  ...
                  onTap: ()=> Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (BuildContext context) =>
                          new ManipularImagenCaprini('assets/EnfermedadTromboembolicaVenosa/ToracicaTabla3.png'))),
                ),
                DividerGeneral(color: c.enfermedadTromboembolicaVenosaRojo,),
                s.espacio(),
              ],
              ...
              children: [
                ...
                InkWell(
                  ...
                  onTap: ()=> Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (BuildContext context) =>
                          new FactoresRiesgoSangrado(atrasRoute: '/ETToracica'))),
                ),
                s.espacio(),
                InkWell(
                  child: RoundedContainerRegularBold(
                  ...
                  onTap: ()=> Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (BuildContext context) =>
                          new ContraindicacionesMecanica(atrasRoute: '/ETToracica'))),
                ),
