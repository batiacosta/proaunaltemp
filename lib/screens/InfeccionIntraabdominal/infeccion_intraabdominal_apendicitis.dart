...
class IntraabdominalApendicitis extends StatefulWidget {
  const IntraabdominalApendicitis({Key key}) : super(key: key);

  @override
  _IntraabdominalApendicitisState createState() => _IntraabdominalApendicitisState();
}

class _IntraabdominalApendicitisState extends State<IntraabdominalApendicitis> {
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                divisorTitulado(context, "Apendicitis"),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: "Para pacientes con apendicitis no perforada, o perforada con peritonitis localizada o generalizada:\n",
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: "Apendicitis no perforada: hasta\n   apendicectomía.\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "•  ",
