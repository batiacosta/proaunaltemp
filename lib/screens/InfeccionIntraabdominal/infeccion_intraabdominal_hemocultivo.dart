...
class IntraabdominalHemocultivo extends StatefulWidget {
  const IntraabdominalHemocultivo({Key key}) : super(key: key);

  @override
  _IntraabdominalHemocultivoState createState() => _IntraabdominalHemocultivoState();
}

class _IntraabdominalHemocultivoState extends State<IntraabdominalHemocultivo> {
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                divisorTitulado(context, "Hemocultivos"),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          triangulito(context),
                          TextSpan(
                            text: "No tomar hemocultivos de forma rutinaria en pacientes con IIA adquirida en la comunidad.\n",
                            style: _estiloLetra1(context),
                          ),
                          chulo(context),
                          TextSpan(
                            text: "Tomar hemocultivos en pacientes con IIA que requieren manejo en unidad de cuidado intensivo.\n",
                            style: _estiloLetra1(context),
                          ),
