...
class IntraabdominalDiverticulitis extends StatefulWidget {
  const IntraabdominalDiverticulitis({Key key}) : super(key: key);

  @override
  _IntraabdominalDiverticulitisState createState() => _IntraabdominalDiverticulitisState();
}

class _IntraabdominalDiverticulitisState extends State<IntraabdominalDiverticulitis> {
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                divisorTitulado(context, "Diverticulitis"),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          rombo(context),
                          TextSpan(
                            text: "En pacientes con diverticulitis no complicada, no se recomienda el uso de antibióticos.\n",
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          rombo(context),
                          TextSpan(
                            text: "Para pacientes con diverticuitis complicada:\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "•  ",
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: "Hasta 5 días después de adecuado\n   control del foco.\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "•  ",
                          ...
                          TextSpan(
                            text: "Si no es posible el control del foco,\n   dependiendo el tamaño del absceso.\n",
                            style: _estiloLetra1(context),
                          ),
                        ]
                    ),
