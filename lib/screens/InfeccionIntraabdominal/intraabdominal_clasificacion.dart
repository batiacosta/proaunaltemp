...
class IntraabdominalClasificacion extends StatefulWidget {
  const IntraabdominalClasificacion({Key key}) : super(key: key);

  @override
  _IntraabdominalClasificacionState createState() => _IntraabdominalClasificacionState();
}

class _IntraabdominalClasificacionState extends State<IntraabdominalClasificacion> {
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                ImagenEncabezadoSeccion("assets/InfeccionIntraabdominal/intraabdominal_b1.png"),
                ...
                Container(
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          TextSpan(
                            text: "Las infecciones intraabdominales (IIA) constituyen un grupo de afecciones, que se pueden clasificar en:\n",
                          ...
                          TextSpan(
                            text: "Infección no complicada: ",
                            style: _estiloLetraColorMedio(context),
                          ),
                          TextSpan(
                            text: "IIA que se\n   limita al órgano de origen y no involucra\n   el peritoneo, (por ejemplo: apendicitis,\n   colecistitis, diverticulitis).\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "•  ",
                          ...
                          TextSpan(
                            text: "Infección complicada:",
                            style: _estiloLetraColorMedio(context),
                          ),
                          TextSpan(
                            text: " IIA que se\n   extiende al peritoneo (por ejemplo:\n   peritonitis difusas o localizadas como los\n   abscesos).\n",
                            style: _estiloLetra1(context),
                          ),
                        ]
                    ),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: "Peritonitis sin foco evidente\n       intraabdominal (por ejemplo:\n       peritonitis bacteriana espontánea).\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "   -  Secundaria: ",
                          ...
                          TextSpan(
                            text: "Peritonitis que es\n       consecuencia de una perforación\n       gastrointestinal o de un absceso\n       visceral.\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "   -  Terciaria: ",
                          ...
                          TextSpan(
                            text: "Peritonitis secundaria que\n       persiste a pesar de instaurar\n       tratamiento antibiótico adecuado y\n       realizar manejo  quirúrgico.\n",
                            style: _estiloLetra1(context),
                          ),
                        ]
                    ),
