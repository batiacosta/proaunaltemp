...
class IntraabdominalImagenes extends StatefulWidget {
  const IntraabdominalImagenes({Key key}) : super(key: key);

  @override
  _IntraabdominalImagenesState createState() => _IntraabdominalImagenesState();
}

class _IntraabdominalImagenesState extends State<IntraabdominalImagenes> {
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                divisorTitulado(context, "  Imágenes diagnósticas"),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          chulo(context),
                          TextSpan(
                            text: "Usar la tomografía computarizada, idealmente con contraste intravenoso, según disponibilidad. \n",
                ...
                Container(
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          TextSpan(
                            text: "Como puntos de buena practica:\n",
                            style: _estiloLetraColorMedioBold(context),
                          ),
                          TextSpan(
                            text: "•  ",
                          ...
                          TextSpan(
                            text: "Considere el uso de la ecografía.\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "•  ",
                          ...
                          TextSpan(
                            text: "En pacientes críticamente enfermos con\n   indicación de manejo quirúrgico, no\n   retrasar la intervención por la toma de\n   imágenes diagnósticas.\n",
                            style: _estiloLetra1(context),
                          ),
                        ]
                    ),
