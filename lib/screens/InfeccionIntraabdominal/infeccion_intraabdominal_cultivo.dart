...
class IntraabdominalCultivo extends StatefulWidget {
  const IntraabdominalCultivo({Key key}) : super(key: key);

  @override
  _IntraabdominalCultivoState createState() => _IntraabdominalCultivoState();
}

class _IntraabdominalCultivoState extends State<IntraabdominalCultivo> {
  @override
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                divisorTitulado(context, "Cultivos"),
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          rombo(context),
                          TextSpan(
                            text: "Tomar cultivos antes de iniciar la terapia antimicrobiana empírica, a partir de muestras como líquido peritoneal, bilis, tejido o absceso intraabdominal, líquido de diálisis peritoneal o tubo de drenaje, en pacientes con:\n",
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                            text: "Hallazgo de líquido fibrinopurulento.\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "•  ",
                          ...
                          TextSpan(
                            text: "IIA asociada a la atención en salud.\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "•  ",
                          ...
                          TextSpan(
                            text: "Retraso en el control inicial del foco o\n   incapacidad para realizar completo\n   control del foco.\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "•  ",
                          ...
                          TextSpan(
                            text: "Alto riesgo (dos o más de los siguientes:\n   edad mayor de 70 años, malignidad,\n   enfermedad renal, hepática o\n   cardiovascular significativa e\n   hipoalbuminemia).\n",
                            style: _estiloLetra1(context),
                          ),
                          TextSpan(
                            text: "•  ",
                          ...
                          TextSpan(
                            text: "Índice de peritonitis de Mannheim\n   elevado (≥ 21).\n",
                            style: _estiloLetra1(context),
                          ),
                        ]
                    ),
                ...
                VerImagen("assets/InfeccionIntraabdominal/intraabdominal_Tabla1.png", 1, "t2"),
